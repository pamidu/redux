(function ()
{
    ...
    angular
        .module('app.core')
        .factory('mesGenerator', mesGeneratorService);

    /** @ngInject */
    function mesGeneratorService($cookies, $log, mesTheming)
    {
        ...
        function generate()
        {
            ...
            var registeredThemes = angular.copy(mesTheming.getRegisteredThemes());
            var registeredPalettes = angular.copy(mesTheming.getRegisteredPalettes());
        ...
        function processAndStoreThemes(_themes)
        {
            ...
            mesTheming.setThemesList(themes);
            ...
            if ( selectedTheme )
            {
                mesTheming.setActiveTheme(selectedTheme);
            }
            else
            {
                mesTheming.setActiveTheme('default');
            }
        }
