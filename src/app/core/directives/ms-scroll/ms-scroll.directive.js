(function ()
{
    ...
    /** @ngInject */
    function msScrollDirective($timeout, msScrollConfig, msUtils, mesConfig)
    {
        return {
            restrict: 'AE',
            compile : function (tElement)
            {
                ...
                if ( mesConfig.getConfig('disableCustomScrollbars') )
                {
                    return;
                }
                ...
                if ( mesConfig.getConfig('disableCustomScrollbarsOnMobile') && msUtils.isMobile() )
                {
                    return;
                }
