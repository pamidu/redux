    ...
    lfNgMdFileinput.directive('lfNgMdFileInput',['$q','$compile','$timeout', function($q,$compile,$timeout){
        return {
            ...
            template:  ['<div layout="column" class="lf-ng-md-file-input" ng-model="'+genLfObjId()+'">',
                            '<div layout="column" class="lf-ng-md-file-input-preview-container" ng-class="{\'disabled\':isDisabled}" ng-show="isDrag || (isPreview && !isFilesNull)">',
                                ...
                                '<div class="lf-ng-md-file-input-drag">',
                                    '<div layout="column" layout-align="center center" class="lf-ng-md-file-input-drag-text-container" ng-show="(isFilesNull || !isPreview) && isDrag">',
                                        '<div  layout="row" class="lf-ng-md-file-input-drag-text">{{strCaptionDragAndDrop}}</div>',
                                        '<div  layout="row" class="lf-ng-md-file-input-drag-sub-text">Or, if you prefer</div>',                                         
                                        '<div  layout="row" ng-disabled="isDisabled" class="lf-ng-md-file-input-button lf-ng-md-file-input-button-brower" >',
                                            '<label href="#" class="lf-ng-md-file-input-label" for="fileUpload" style="" ng-click="openDialog($event, this)" >{{strCaptionBrowse}} </label>',
                                            '<input id="fileUpload" type="file" aria-label="{{strAriaLabel}}" accept="{{accept}}"  class="lf-ng-md-file-input-tag" />',//,onchange="angular.element(this).scope().onFileChanged(this)"/>',
                                        '</div>',
                                    '</div>',
            ...
            link: function(scope,element,attrs,ctrl){
				...
				scope.strCaptionDragAndDrop = 'Drag an image here...';

				scope.strCaptionBrowse = 'Choose an image to upload';
