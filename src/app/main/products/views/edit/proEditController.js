(function ()
{
    ...
    /** @ngInject */
    function proEditController($scope, $rootScope, $document, $mdDialog, $mdMedia, $mdSidenav, $state,settingSummary,uploaderService,$imageUploader,$serviceCall,$apis,$setUrl,fileUploader,$auth )
    {
        var vm = this, 
            individualTaxes = [],
            multiplelTaxes = [];
        ...
        function saveEditProduct(){
            ...
            client.ifSuccess(function(data){
                $mdDialog.show(
                      ...
                      .content('Product Successfully Edited.')
