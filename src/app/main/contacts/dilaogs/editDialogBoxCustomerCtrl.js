  (function ()
{
   ...
   // customerController.$inject = ['$mdDialog','$serviceCall','profileID'];
    ...
    function DialogControllerEditCustomer($mdDialog,$serviceCall,profileID,contactEditService,$mdToast,favouriteStar,favouriteStarNo)
    {
                ...
                val.profileLog = {
                    ...
                    client.ifSuccess(function(data){
                      ...
                      contactEditService.setArray(val);
                       ...
                       $mdToast.show(
                              $mdToast.simple()
                                .textContent('Customer Successfully Editted')
