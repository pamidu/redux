(function ()
{
    ...
    angular
        .module('app.invoices')
        .controller('editRecRecCtrl', editRecRecCtrl);

    /** @ngInject */
    function editRecRecCtrl($scope, $rootScope, Invoicecopy, InvoiceService, $serviceCall, $mdToast, $document, $mdDialog, $mdMedia, $mdSidenav, $state)
    {
    	var vm = this;
        ...
        function submit(){
          ...
          function successSubmit(){
            ...
            vm.TDinv.taxAmounts = [];
              ...
              $mdToast.show(
                  $mdToast.simple()
                    .textContent('Recurring Profile No '+ data.ID +'Successfully Updated')
                    .position('top right' )
                    .hideDelay(3000)
                );
             });
