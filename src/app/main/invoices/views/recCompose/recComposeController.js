(function ()
{
    ...
    angular
        .module('app.invoices')
        .controller('RecComposeController', RecComposeController);

    /** @ngInject */
    function RecComposeController($scope,  InvoiceService, $mdPanel, $serviceCall, $mdToast, $document,  $mdDialog, $mdMedia, $mdSidenav, $state)
    {
        var vm = this;
